...
export class GameInfoComponent implements OnInit, OnChanges {
    cardAction = [
        ...
        { title: "Thumbmaster", description: "The player who is the Thumbmaster can put their thumb on the table at any time. The last player to do so has to drink." },
        { title: "Men", description: "All men drink." },
        { title: "Quizmaster", description: "You can ask questions to any or all player, if they answer they have to drink" },
        {
